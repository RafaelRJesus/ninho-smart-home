...
import { Home, LayoutDashboard, Map, Mic, Plus, Power, Send, Settings, Sparkles, Thermometer, Tv, Lamp, PlugZap, Wifi, WifiOff, X, RefreshCw, ArrowUp, ArrowDown, Trash2, DoorOpen, Pencil, Search, AlertCircle, CheckCircle2, Info, Clock, Moon, Sun, Workflow } from 'lucide-react';
...
function App() {
  ...
  return <div className="app">
    <aside>
      ...
      <div className="profile"><div className="avatar">RJ</div><div><b>Minha casa</b><small>Administrador</small></div></div>
    </aside>
    ...
    <main>
      ...
      {view === 'settings' && <SettingsView status={status} connection={connection} deviceCount={devices.length} lastSync={lastSync} reload={load} notify={notify}/>} 
    </main>
